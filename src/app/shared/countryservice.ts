...
import { Country } from '../body/about/country';  
import { State } from '../body/about/state';  
import { City } from '../body/about/city';
...
export class CountryService {  
    ...
    getCities=[
        new City(1,23,'Chitoor'),
        new City(2,23,'Nellore'),
        new City(3,23,'Prakasam'),
        new City(4,23,'Guntur'),
        new City(5,23,'Krishna'), 
        new City(6,23,'EastGodavari'), 
        new City(7,23,'WestGodavari'),
        new City(8,23,'Vizag'),
        new City(9,23,'Vijayanagaram'),
        new City(10,23,'Srikakulam'),
        new City(11,23,'Kadapa'),
        new City(12,23,'Karunool'),
        new City(13,23,'Anatapuram')  
    ]
}   